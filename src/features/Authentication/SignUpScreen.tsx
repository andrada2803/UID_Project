...
import { Text,View, StyleSheet, Linking, TouchableOpacity, TextInput, Dimensions } from 'react-native'
    ...
    <View style={{flex:1, flexDirection:"column", alignContent:"center", alignItems:"center"}} >
        ...
        <View style={{margin:30}}>  
            ...
            <View style={{flexDirection:"row", width:'90%', backgroundColor:"#E2E6EE", borderRadius:10, paddingTop:8,paddingBottom:8, paddingLeft:12, paddingRight:12,marginBottom:20 }}>
                <ProfileIcon/>
                <TextInput style={{marginLeft:10, width:'90%'}} placeholder='Full name' onChangeText={(text)=>setName(text)} value={name}/>
            </View>
            ...
            <View style={{flexDirection:"row",width:'90%', backgroundColor:"#E2E6EE", borderRadius:10, paddingTop:8,paddingBottom:8, paddingLeft:12, paddingRight:12,}}>
                <LockIcon/>
                <TextInput secureTextEntry={true} style={{marginLeft:10, width:'90%'}} placeholder='Confirm Password' onChangeText={(text)=>setConfirmPassword(text)} value={passwordConfirm}/>
            </View>
